    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      <header className="w-full max-w-4xl text-center mb-12">
        ...
        <p className="text-xl text-gray-600">
          Powering your future with innovative electrical solutions
        </p>
      </header>

      {/* Main Content */}
      <main className="w-full max-w-2xl text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          Our New Website is Coming Soon!
        </h2>
        <p className="text-lg text-gray-600 mb-8">
          We're working hard to bring you an improved online experience. Stay
        ...
        <div className="bg-red-50 p-6 rounded-lg border border-red-100">
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-2 md:space-y-0 md:space-x-8">
            ...
            <div className="flex items-center justify-center">
              ...
              <span className="text-gray-700">info@santoshielectro.com</span>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="w-full max-w-4xl text-center border-t border-red-100 pt-6">
        ...
        <p className="text-gray-500 text-sm">
          © {new Date().getFullYear()} Santoshi Electro Engineering Company. All
          rights reserved.
        </p>
      </footer>
    </div>
